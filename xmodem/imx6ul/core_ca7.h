...
FORCEDINLINE __STATIC_INLINE void GIC_DisableIRQ(uint32_t IRQn)
{
  	GIC_Type *gic = (GIC_Type *)(__get_CBAR() & 0xFFFF0000UL);
 ...
 * 设置优先级
 */
FORCEDINLINE __STATIC_INLINE void GIC_SetPriority(uint32_t IRQn, uint32_t priority)
{
  	GIC_Type *gic = (GIC_Type *)(__get_CBAR() & 0xFFFF0000UL);
 ...
 * 获取优先级
 */
FORCEDINLINE __STATIC_INLINE uint32_t GIC_GetPriority(uint32_t IRQn)
{
  GIC_Type *gic = (GIC_Type *)(__get_CBAR() & 0xFFFF0000UL);
